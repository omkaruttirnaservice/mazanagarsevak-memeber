...
import React__default, { useEffect, useState, useMemo, Component, useRef } from "react";
import { renderToPipeableStream } from "react-dom/server";
import { toast, ToastContainer } from "react-toastify";
import { FiX, FiMenu, FiMessageSquare, FiMail, FiMapPin } from "react-icons/fi";
import "react-dom";
import { UNSAFE_NavigationContext, useHref, useNavigate, useLocation, useResolvedPath, createPath, UNSAFE_DataRouterStateContext, UNSAFE_useRouteId, UNSAFE_RouteContext, UNSAFE_DataRouterContext, Outlet, Routes, Route, parsePath, Router } from "react-router";
...
import { FaFacebook, FaInstagram, FaTwitter, FaYoutube, FaUser, FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaArrowRight, FaCrown, FaCalendarAlt, FaGlobe, FaHistory, FaExternalLinkAlt, FaWhatsapp, FaInfoCircle } from "react-icons/fa";
...
const BASE_URL = "https://api.mazanagarsevak.com";
const api = axios.create({
  baseURL: BASE_URL
});
const fetchRepresentativeById = async (id, domain) => {
...
const { clearRepresentative, setMemberData } = representativeSlice.actions;
...
const Header = () => {
  ...
  const BASE_URL2 = "https://api.mazanagarsevak.com";
  const imageSrc = useMemo(() => {
    return representative?.representativephoto ? `${BASE_URL2}/uploads/representative/${representative.representativephoto}` : "/logo.jpg";
  }, [representative]);
  ...
  return /* @__PURE__ */ jsxs("header", { className: "fixed top-0 left-0 w-full z-50 bg-[#1c3c52] shadow-md", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 py-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 text-white", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-lg md:text-2xl font-extrabold tracking-wide", children: representative?.name || "माझा नगर सेवक" })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    isMobileMenuOpen && /* @__PURE__ */ jsx("div", { className: "md:hidden bg-[#1c3c52] px-4 pb-4", children: /* @__PURE__ */ jsx("nav", { className: "flex flex-col gap-3", children: navItems.map(({ name, path }) => /* @__PURE__ */ jsx(
      Link,
      {
        to: path,
        className: `text-white text-base font-medium border-b pb-2 ${location.pathname === path ? "text-orange-400" : "border-gray-600"}`,
...
const MemberBar = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: selectedMember.representativephoto && /* @__PURE__ */ jsxs("div", { className: "fixed bottom-1 lg:bottom-4 right-2 w-[70%] sm:w-[60%] md:w-[40%] lg:w-[35%] xl:w-[20%] max-w-sm bg-black/50 backdrop-blur-md text-white shadow-lg rounded-xl px-3 py-2 lg:py-2 flex items-center gap-3 z-50 animate-fade-in-slide", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-hidden", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-base sm:text-lg font-semibold truncate", children: selectedMember.name }),
      /* @__PURE__ */ jsxs("h3", { className: "font-semibold text-white text-sm", children: [
        "संपर्क: ",
        /* @__PURE__ */ jsx("span", { className: "text-white", children: selectedMember.contactNo })
      ] })
    ] })
  ] }) });
};
  ...
  return /* @__PURE__ */ jsxs("footer", { className: "bg-gradient-to-r from-[#243c5a] via-[#1c3c52] to-[#2a506f] border-t border-blue-200 mt-12 px-4 py-10 sm:py-12 shadow-inner", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 w-full lg:w-2/3 lg:h-[22vh]", children: [
        /* @__PURE__ */ jsx(Link, { to: "/contact-member", className: "block h-full", children: /* @__PURE__ */ jsx("div", { className: "bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition text-center flex items-center justify-center h-full", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full w-full", children: [
        ...
        /* @__PURE__ */ jsx(Link, { to: "/videos", className: "block h-full", children: /* @__PURE__ */ jsx("div", { className: "bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition text-center flex items-center justify-center h-full", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "text-blue-600 text-2xl sm:text-3xl mb-2", children: /* @__PURE__ */ jsx(FiMessageSquare, {}) }),
          /* @__PURE__ */ jsx("h3", { className: "text-sm sm:text-base font-semibold text-blue-800", children: "बातम्या" })
        ] }) }) }),
        /* @__PURE__ */ jsx(Link, { to: "/privacy-policy", className: "block h-full", children: /* @__PURE__ */ jsx("div", { className: "bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition text-center flex items-center justify-center h-full", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-full w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "text-blue-600 text-2xl sm:text-3xl mb-2", children: /* @__PURE__ */ jsx(FiMessageSquare, {}) }),
          /* @__PURE__ */ jsx("h3", { className: "text-sm sm:text-base font-semibold text-blue-800", children: "Privacy Policy" })
        ] }) }) })
      ] }),
...
const Navbar = () => {
  ...
  const links = [
    { label: "मुख्यपृष्ठ", path: `/`, icon: /* @__PURE__ */ jsx(TbHome2, {}) },
    { label: "नागरीक सुविधा", path: `/nagrik-suvidha`, icon: /* @__PURE__ */ jsx(TbChecklist, {}) },
    { label: "पक्षाची माहिती", path: `/about-party`, icon: /* @__PURE__ */ jsx(TbFlag3, {}) },
    { label: "राजकीय प्रवास", path: `/about-member`, icon: /* @__PURE__ */ jsx(TbUserShield, {}) },
    { label: "सामाजिक कार्य", path: `/social-work`, icon: /* @__PURE__ */ jsx(TbHeartHandshake, {}) },
    { label: "विडिओ", path: `/videos`, icon: /* @__PURE__ */ jsx(TbVideo, {}) },
    { label: "फोटो", path: `/images`, icon: /* @__PURE__ */ jsx(TbPhoto, {}) },
    { label: "संपर्क साधा", path: `/contact-member`, icon: /* @__PURE__ */ jsx(TbPhoneCall, {}) }
  ];
  return /* @__PURE__ */ jsx("div", { className: "bg-black/30 backdrop-blur-md py-3 px-2 shadow-md w-full overflow-x-auto scrollbar-hide", children: /* @__PURE__ */ jsx("nav", { className: "flex gap-3 sm:gap-4 text-sm sm:text-base font-medium text-white min-w-max justify-center sm:justify-center", children: links.map(({ label, path, icon }, idx) => {
    const fullPath = subdomain ? `https://${subdomain}.mazhanagarsevak.com${path}` : path;
    const isActive = location.pathname === path;
    return subdomain ? /* @__PURE__ */ jsx("a", { href: fullPath, className: "shrink-0", children: /* @__PURE__ */ jsxs(
      "button",
      {
        className: `flex items-center gap-2 px-4 py-2 rounded-md transition duration-200 shadow-sm border whitespace-nowrap
                  ${isActive ? "bg-orange-600 text-white border-orange-600" : "bg-white text-black font-semibold hover:bg-gray-100 border-gray-300"}`,
        children: [
...
const MemberIntroSlider = ({ cityData }) => {
  ...
  const getImageUrl = (imageName) => `${"https://api.mazanagarsevak.com"}/uploads/representative/work/${imageName}`;
  const fallbackImage = "/fallback-image.jpg";
  const currentImage = works.length > 0 ? getImageUrl(works[current].image) : fallbackImage;
...
const NagrikSuvidha = ({ memberData }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (openCategory && emergencyModalRef.current && !emergencyModalRef.current.contains(event.target)) {
        closeModal();
      }
      if (showGovtSchemes && govtSchemeModalRef.current && !govtSchemeModalRef.current.contains(event.target)) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative py-10 bg-gradient-to-b from-orange-200 via-white to-green-200 min-h-[90vh] mb-6 px-4 sm:px-6 lg:px-12 mt-28 overflow-hidden", children: [
    ...
    openCategory && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center px-4 py-6 sm:py-12 overflow-auto", children: /* @__PURE__ */ jsxs(
      "div",
      {
    ...
    showGovtSchemes && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center px-4 py-6 sm:py-12 overflow-auto", children: /* @__PURE__ */ jsxs(
      "div",
      {
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsx("span", { className: "text-2xl text-indigo-600", children: scheme.icon || "📋" })
                      }
                    ),
                    /* @__PURE__ */ jsxs("div", { children: [
...
const NagrikSuvidhaPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      /* @__PURE__ */ jsx("title", { children: memberData?.name ? `नागरीक सुविधा | ${memberData?.name}` : "नागरीक सुविधा" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
          content: memberData?.name ? `${memberData?.name} यांच्या समाजकार्याशी संबंधित विविध नागरीक सुविधा उपक्रमांची माहिती.` : "समाजकार्य व विविध उपक्रमांच्या खास छायाचित्रांचा संग्रह."
        }
      )
    ] }),
...
function SocialWorkSection({ memberData }) {
...
const SocialWorkPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "min-h-screen relative flex flex-col items-center justify-start px-4 py-10 bg-gradient-to-b from-orange-200 via-white to-green-200", children: /* @__PURE__ */ jsx(SocialWorkSection, { memberData: representative }) })
  ] });
};
const PrivacyPolicy = () => {
  return /* @__PURE__ */ jsx("section", { className: "py-20 bg-gradient-to-b from-orange-200 via-white to-green-200 min-h-screen overflow-y-auto", children: /* @__PURE__ */ jsx(
    "div",
    {
      className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20",
      style: { fontFamily: '"Noto Sans Devanagari", sans-serif' },
      children: /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-2xl rounded-2xl p-10 md:p-14 space-y-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold text-center text-orange-700 mb-8 drop-shadow-sm", children: "Privacy Policy" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-center mb-6", children: /* @__PURE__ */ jsx("strong", { children: "Last Updated: 13 Nov,2025" }) }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-gray-800 mb-2", children: "1. Collecting and Using Your Personal Data" }),
            /* @__PURE__ */ jsxs("p", { className: "text-gray-700 leading-relaxed", children: [
              /* @__PURE__ */ jsxs("strong", { children: [
                " ",
                "We do not collect, store, or share any of your personal data with third parties."
              ] }),
              " ",
              "The application works entirely safely and only provides publicly available information about representatives."
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-gray-800 mb-2", children: "2. App Features" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed", children: "This app provides detailed information about representatives, including their work, history, biography, videos, images, and social media profiles. All the information is publicly available, and we do not share any personal data with third-party applications." })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-gray-800 mb-2", children: "3. Children's Privacy" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed", children: "Our application is not intended for children under the age of 13. We do not knowingly collect any personal information from children." })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold text-gray-800 mb-2", children: "4. Updates to This Privacy Policy" }),
            /* @__PURE__ */ jsxs("p", { className: "text-gray-700 leading-relaxed", children: [
              "We may update our Privacy Policy from time to time. Any changes will be posted on this page, and the",
              " ",
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-gray-500 text-sm mt-6 text-center", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Nagrik Suvicha. All rights reserved."
        ] })
      ] })
    }
  ) });
};
const getDomain = (paramDomain) => {
...
const AppRedirect = () => {
  useEffect(() => {
    const baseUrl = "https://api.mazanagarsevak.com";
    ...
    const domain = fullDomainUrl.replace(/^https?:\/\//, "").split(".")[0];
    console.log("Extracted domain:", domain);
    const redirectUrl = `${baseUrl}/uploads/app/${domain}.apk`;
    console.log("✅ Redirecting to APK URL: ", redirectUrl);
    window.location.replace(redirectUrl);
  }, []);
  return /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginTop: "2rem", fontFamily: "Arial" }, children: [
    /* @__PURE__ */ jsx("h3", { children: "📲 Redirecting to app download..." }),
...
function App() {
  ...
  if (domainNotFound) {
    return /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", padding: "2rem", fontFamily: "Arial" }, children: [
      /* @__PURE__ */ jsx("h2", { children: "⚠️ डोमेन ओळखण्यात अयशस्वी." }),
      /* @__PURE__ */ jsx("p", { children: "डेटा मिळवण्यासाठी कृपया पृष्ठ पुन्हा लोड करा." }),
      /* @__PURE__ */ jsx(
        "button",
        {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsx(Route, { path: "/app.apk", element: /* @__PURE__ */ jsx(AppRedirect, {}) }),
      /* @__PURE__ */ jsxs(Route, { path: "/", element: /* @__PURE__ */ jsx(MemberLayout, {}), children: [
        ...
        /* @__PURE__ */ jsx(Route, { path: "*", element: /* @__PURE__ */ jsx(MemberMainPage, {}) })
      ] })
    ] }),
...
const subdomainSlice = createSlice({
  ...
  initialState: {
    value: ""
    // Default empty, will be filled client-side
  },
  reducers: {
    setSubdomain: (state, action) => {
      console.log("✅ Subdomain set to:", action.payload);
      state.value = action.payload;
    }
  }
});
const { setSubdomain } = subdomainSlice.actions;
const subdomainReducer = subdomainSlice.reducer;
...
function render(url, options) {
  ...
  return renderToPipeableStream(
    /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(HelmetProvider, { context: helmetContext, children: /* @__PURE__ */ jsxs(Provider, { store, children: [
      " ",
